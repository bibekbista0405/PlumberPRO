...
function Terms() {
  return <main className="legal-page">
    ...
    <article className="legal-card">
      ...
      <h2>2. Accounts</h2>
      <p>You're responsible for keeping your login credentials confidential and for any activity carried out through your account. Plumber accounts go through an admin verification step before they're shown in public search. Administrators may create or manage accounts as part of running the platform.</p>
      <h2>3. Bookings</h2>
