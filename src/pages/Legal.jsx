...
function Legal() {
  return <main className="legal-page">
    ...
    <article className="legal-card">
      ...
      <p>PlumbPro is a booking platform that connects customers with independent, admin-verified plumbers operating in their area. We handle discovery, booking, status tracking and reviews — the plumbing work itself is carried out by the plumber you book, not by PlumbPro directly.</p>
      ...
      <h2>Verification</h2>
      <p>Plumbers go through an admin review before their profile appears in search — we check the professional details they submit, such as experience and service area. Verification reflects the information provided at the time of review; it isn't a certification of every individual job.</p>
