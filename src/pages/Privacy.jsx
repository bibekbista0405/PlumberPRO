...
function Privacy() {
  return <main className="legal-page">
    ...
    <article className="legal-card">
      ...
      <p>We use it to authenticate your account, process and track bookings, connect customers with plumbers, respond to messages sent through the contact form, and operate the day-to-day running of the platform — like verifying plumber profiles.</p>
      <h2>4. Who can see it</h2>
      <p>Customers and plumbers see the information needed to complete a booking together — name, contact details, service address and job status. Our platform team can access account and booking records to verify plumbers, resolve issues, and keep the platform running smoothly. We don't sell your information or share it with advertisers.</p>
      <h2>5. Security</h2>
