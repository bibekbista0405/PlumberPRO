...
return <>{!dashboardRoute&&<Navbar/>}{!dashboardRoute&&location.pathname==='/'&&<WelcomeBanner/>}<div className="route-transition" key={location.pathname}><Routes location={location}><Route path="/" element={<Home/>}/><Route path="/services" element={<Services/>}/><Route path="/about" element={<About/>}/><Route path="/contact" element={<Contact/>}/><Route path="/blog" element={<Blog/>}/><Route path="/blog/:slug" element={<BlogPost/>}/><Route path="/plumbers/:id" element={<PlumberProfile/>}/><Route path="/book-plumber" element={<BookPlumber/>}/><Route path="/login" element={<LoginRegister/>}/><Route path="/terms" element={<Terms/>}/><Route path="/privacy" element={<Privacy/>}/><Route path="/legal" element={<Legal/>}/><Route path="/cancellation-policy" element={<CancellationPolicy/>}/><Route path="/customer-dashboard" element={<ProtectedRoute roles={['customer']}><CustomerDashboard/></ProtectedRoute>}/><Route path="/plumber-dashboard" element={<ProtectedRoute roles={['plumber']}><PlumberDashboard/></ProtectedRoute>}/><Route path="/admin-dashboard" element={<ProtectedRoute roles={['admin']}><AdminDashboard/></ProtectedRoute>}/></Routes></div>{!dashboardRoute&&location.pathname!=='/login'&&<Footer/>}</>}
function App(){return <BrowserRouter><ConfirmProvider><Layout/></ConfirmProvider></BrowserRouter>}
export default App;
